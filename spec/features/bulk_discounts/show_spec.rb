...
RSpec.describe "merchant dashboard" do
  before :each do
    ...
    visit "/merchants/#{@merchant1.id}/bulk_discounts/#{@bulk_discount_1.id}"
  end

  it "when visit my bulk discount show page 
  I see the bulk discount's quantity threshold and percentage discount" do
